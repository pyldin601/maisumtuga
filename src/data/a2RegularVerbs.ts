...
const regularVerbInputs: RegularVerbInput[] = [
  ...
  { infinitive: 'custar', translations: ['to cost'] },
  ...
  { infinitive: 'chover', translations: ['to rain'] },
  ...
  { infinitive: 'nevar', translations: ['to snow'] },
  ...
  { infinitive: 'partir (a perna)', baseInfinitive: 'partir', suffix: 'a perna', translations: ['to break a leg'] },
  ...
  { infinitive: 'apetecer', translations: ['to feel like'] },
  ...
  { infinitive: 'acontecer', translations: ['to happen'] },
